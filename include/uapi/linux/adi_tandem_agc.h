...
#define ADI_TANDEM_AGC_FAULT_INDEX_MISMATCH	(1U << 1)
#define ADI_TANDEM_AGC_FAULT_RADIO_STATE	(1U << 16)
#define ADI_TANDEM_AGC_FAULT_RADIO_IO		(1U << 17)
#define ADI_TANDEM_AGC_FAULT_WATCHDOG		(1U << 18)
